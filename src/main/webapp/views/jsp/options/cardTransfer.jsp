...
<html>
<head>
    <title><fmt:message key="cardTransfer"/></title>
    ...
    <div class="rounded d-flex justify-content-center">
        <div class="col-md-4 col-sm-12 shadow-lg px-5 pt-5 bg-light">
            <div class="text-center">
                <h3 class="text-primary"><fmt:message key="cardTransfer"/></h3>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/user/cardTransfer" method="post">
                <div class="p-4">
                    ...
                    <c:if test="${requestScope.valid.cardNumber == 'false'}">
                        <div><cite style="color: red; font-size: 11px"><fmt:message key="cardNumberError"/></cite></div>
                    </c:if>
