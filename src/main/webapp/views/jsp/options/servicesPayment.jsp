    ...
    <div class="rounded d-flex justify-content-center">
        <div class="col-md-4 col-sm-12 shadow-lg px-5 pt-5 bg-light">
            <div class="text-center">
                <h3 class="text-primary">Оплата послуг</h3>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/user/servicesPayment   " method="post">
                <div class="p-4">
                    ...
                    <div class="input-group mt-3">
                        <input name="card" class="form-control" placeholder="Номер карти">
                    </div>
                    ...
                    <div class="input-group mt-3">
                        <input name="name" class="form-control" placeholder="Послуга">
                    </div>
