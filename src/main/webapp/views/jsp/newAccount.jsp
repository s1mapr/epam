...
<div class="container mt-5 mb-4">
    ...
    <form action="${pageContext.request.contextPath}/user/addNewAccount?id=${sessionScope.accountId}" method="post">
        <div class="inputBox">
            <input type="text" maxlength="16" class="card-number-input" name="card"
        ...
        <c:if test="${requestScope.cardExist != null}">
            <cite style="color: red; font-size:11px"><fmt:message key="cardExist"/></cite>
        </c:if>
        <div class="inputBox">
            <input type="text" class="card-holder-input" name="cardHolder"
                   placeholder="<fmt:message key="cardHolder"/>">
        </div>
        ...
        <div class="flexbox">
            ...
            <div class="inputBox">
                ...
                <c:if test="${requestScope.valid.accountName == 'false'}">
                    <cite style="color: red; font-size:11px"><fmt:message key="accountNameError"/></cite>
                </c:if>
                <c:if test="${requestScope.accountExist != null}">
                    <cite style="color: red; font-size:11px"><fmt:message key="accountExist"/></cite>
                </c:if>
            </div>
